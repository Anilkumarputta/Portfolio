...
export const texts = {
  pt: {
    ...
    about: {
      title: "<sobre/>",
      text: "Olá! Meu nome é Beatriz. Sou Engenheira de Computação, com pós-graduação em Engenharia de Software. Atualmente, trabalho como Desenvolvedora Full Stack Pleno na",
      empresa: " Sistema ESO",
  ...
  en: {
    ...
    about: {
      title: "<about/>",
      text: "Hello! My name is Beatriz. I am a Computer Engineer, with a postgraduate degree in Software Engineering. I currently work as a Mid-Level Full Stack Developer at",
      empresa: " Sistema ESO",
      link: "https://sistemaeso.com.br",
